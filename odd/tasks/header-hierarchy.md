...
- [x] **HH-1 — Refine header hierarchy and favicon**
  ...
  - Commit: `5105c9e` (`feat(ui): refine header hierarchy`).
...
- Work-unit commit: `5105c9e` (`feat(ui): refine header hierarchy`).

## Next step
Open a PR linked to issue #5, wait for CI, and merge it into `main`.
